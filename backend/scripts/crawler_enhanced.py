...
async def main():
    ...
    import fcntl
    warnings.warn(
        "DEPRECATED: crawler_enhanced.py is superseded by live_crawler.py (integrated into the FastAPI app). "
    ...
    print("=" * 60)
    print("WARNING: This crawler is DEPRECATED.")
    print("Use the live_crawler integrated in the API service.")
    print("=" * 60)
